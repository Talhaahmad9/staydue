...
export default function OverdueEmail({ payload }: OverdueEmailProps) {
  const { deadline } = payload;
  const { title, courseCode, courseTitle, dueDate } = deadline;
      ...
      >
        <Container style={{ maxWidth: "600px", margin: "0 auto", padding: "24px" }}>
          ...
          <Section style={{ textAlign: "center" }}>
            ...
            >
              Mark this as submitted in StayDue if you&apos;ve already turned it in.
            </Text>
